...
import (
	...
	"github.com/FluxNetworks/fluxpm/internal/utils"
)

// Frontend serves the index.html file
func (h *FluxpmHandler) Frontend(w http.ResponseWriter, r *http.Request) {
...
func (h *FluxpmHandler) ProfileImageUpload(w http.ResponseWriter, r *http.Request) {
