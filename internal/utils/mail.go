...
func SendEmailInvite(cfg config.EmailConfig, invite EmailInvite) error {
	h := hermes.Hermes{
		Product: hermes.Product{
			Name: "Taskscafe",
			Link: cfg.SiteURL,
			Logo: "https://github.com/FluxNetworks/fluxpm/raw/master/.github/fluxpm-full.png",
		},
	}
	...
	email := hermes.Email{
		Body: hermes.Body{
			...
			Intros: []string{
				"You have been invited to join FluxPM",
			},
			Actions: []hermes.Action{
				{
					Instructions: "To get started with FluxPM, please click here:",
	...
	// Set E-Mail subject
	m.SetHeader("Subject", "You have been invited to FluxPM")
